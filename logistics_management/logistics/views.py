...
def logistics_detail(request, pk):
    ...
    print(time)
    city_coordinates = [
        {"lat": coordinates[point][0], "lng": coordinates[point][1]}
...
graph = {
    ...
    "Bilasuvar": {"Imishli": 80.4, "Saatli": 89.3, "Sabirabad": 82.1, "Masally":53.3},
    ...
    "Gobustan": {"Khirdalan": 85.3, "Shamakhi":31.4},
    "Xizi": {"Siyazan": 33.5, "Khachmaz": 93.0, "Sumgayit": 44.1},
    "Hajigabul": {"Baku": 120.0, "Shamakhi": 94.8, "Aghsu": 104.7, "Kurdamir": 79.3, "Sabirabad": 56.8, "Shirvan": 15.8, "Neftchala":104.9},
    ...
    "Khankendi": {"Shusha": 14.3, "Khojavend": 41.2, "Kalbajar": 120.9, "Aghdam":25.5},
    "Khojavend": {"Aghdam": 32.8, "Fuzuli": 26.8, "Khankendi": 41.2},
    "Khirdalan": {"Sumgayit": 20.2, "Baku": 15.6, "Gobustan": 85.3},
    ...
    "Masally": {"Neftchala": 126.2, "Lankaran": 39.2, "Lerik": 53.0, "Yardimli": 55.6, "Bilasuvar":53.3},
    ...
    "Neftchala": {"Masally": 126.2, "Lankaran": 161.0, "Hajigabul":104.9},
...
coordinates = {
    ...
    "Gobustan": (40.535, 48.9211111),
    "Xizi": (40.8653, 49.3403),
